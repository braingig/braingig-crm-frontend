                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="text-sm text-gray-900 dark:text-white">
                                                            {(() => {
                                                                // If we have a completed entry with duration from backend, use it directly
                                                                // Backend already calculated actual work time excluding inactive periods
                                                                if (entry.endTime && entry.duration !== undefined && entry.duration !== null) {
                                                                    return formatDuration(entry.duration * 60); // Backend duration is in minutes
                                                                }
                                                                // Fallback for active entries or missing duration - use raw time difference
